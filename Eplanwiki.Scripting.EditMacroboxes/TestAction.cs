...
namespace Eplanwiki.Scripting.EditMacroboxes
{
    ...
    public class TestAction : IEplAction
    {
        ...
        public bool Execute(ActionCallingContext ctx)
        {
            // TODO: 
            // Add code
            //System.Windows.Forms.MessageBox.Show("TestAction was called!" );
            new EplanScriptHelper().RenameMacroBoxesAfterPageStructure();
            return true;
        }
        /// <summary>
        ...
        public void GetActionProperties(ref ActionProperties actionProperties)
        {
            ...
            // firstParam.set("Param1", "1. Parameter for TestAction"); 
            // actionProperties.addParameter(firstParam);

            // Description 2nd parameter
            // ActionParameterProperties firstParam= new ActionParameterProperties();
            // firstParam.set("Param2", "2. Parameter for TestAction"); 
            // actionProperties.addParameter(firstParam);
